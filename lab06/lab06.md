...
2. Определите длину (в байтах) для каждого поля UDP-заголовка, обращаясь к отображаемой информации о содержимом полей в данном пакете.
   - Каждое поле имеет длину 2 байта:
3. Значение в поле Length (Длина) – это длина чего?
   - Всей udp дейтаграммы (включая заголовок и полезную нагрузку) - тут 8+39
...
6. Какой номер протокола для протокола UDP? Дайте ответ и для шестнадцатеричной и
   ...
   -  17 — в десятичной системе
   -  0x11 — в шестнадцатеричной системе
7. Проверьте UDP-пакет и ответный UDP-пакет, отправляемый вашим хостом. Определите
   отношение между номерами портов в двух пакетах.
   - запрос: Source Port = 47708, Destination Port = 53
   - ответ: Source Port = 53, Destination Port = 47708
