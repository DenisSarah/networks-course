...
3. Какой порядковый номер у SYN TCP-сегмента, который используется для установления
   ...
   - порядковый номер SYN: 0 или (raw): 2203961555
   - у него установлен флаг  -  SYN Flags: 0x002 (SYN)
...
4. Какой порядковый номер у SYNACK-сегмента, отправленного сервером gaia.cs.umass.edu
   ...
   - значение поля Acknowledgment: 1
   - клиент в SYN отправил Seq=0, к нему надо добавить 1
   - в пакете одновременно стоят флаги SYN и ACK
...
5. Какой порядковый номер у TCP-сегмента, содержащего команду POST протокола HTTP?
   ...
   - Sequence Number: 1    (relative sequence number), Sequence Number (raw): 2203961556
...
6. Рассмотрите TCP-сегмент, содержащий команду POST протокола HTTP, как первый TCP-сегмент 
   ...
   - 1, 17:01:59.909303707, 17:02:00.080559762, 0.171256055 c 
   - 619, 17:01:59.909506471, 17:02:00.082667270, 0.173160799 c
   - 3475, 17:01:59.909516499, 17:02:00.086855325, 0.177338826 c
   - 6331, 17:01:59.911355635, 17:02:00.086855409, 0.175499774 c
   - 9187, 17:01:59.911963348, 17:02:00.086855427, 0.174892079 c
   - 12043, 17:01:59.912450468, 17:02:00.086855445, 0.174404977 c
...
7. Чему равна пропускная способность (количество байтов, передаваемых в единицу
   ...
   - Throughput = Объём переданных данных / Время передачи
   - 17:02:00.687606068 - 17:01:59.909303707 = 0.778302361
   - 152940 - 1 = 152939 байт
   - 152939​/0.778302361 = 196503 байт/с
...
Реализация в udp_ping_server.py
...
#### Демонстрация работы
Реализация в udp_ping_client.py
